...
def parse_opts():
    ...
    parser.add_argument('--video_path', default='/tmp/test.mp4', type=str, help='Full path to input video file')
    parser.add_argument('--model', default='/home/ubuntu/samosa-video-deduplication/video_features_generator/pretrained_models/resnet-34-kinetics.pth', type=str, help='Model file path')
